        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          >
            <div>
              {/* Category badge */}
              <span
                className="inline-block text-white text-xs font-black px-3 py-1.5 mb-4 shadow-lg"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-600 text-sm">
                    ...
                    {product.isAvailable ? (
                      ...
                      <span className="text-[#e81123] font-bold">
                        Unavailable
                      </span>
                    )}
                  </span>
            ...
            <div className="space-y-3">
              ...
              <Link to="/products">
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full h-14 font-bold border-2 border-gray-300 hover:border-gray-900"
                >
                  CONTINUE BROWSING
                </Button>
              </Link>
